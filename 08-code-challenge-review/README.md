...
- how to test code 
  - how to use pry effectively (both inside the methods as well as return values)
- class and instance methods inside other methods
- how to interpret deliverables--objects or specific outputs